...
import { CATEGORIES_SERVICE_NAME, CategoriesServiceClient, CreateCategoryDto, UpdateCategoryDto } from '@app/contracts/categories';
...
export class CategoriesService implements OnModuleInit {
	...
	onModuleInit() {
		this.categtoriesServiceClient = this.productsClient.getService<CategoriesServiceClient>(CATEGORIES_SERVICE_NAME);
	}
