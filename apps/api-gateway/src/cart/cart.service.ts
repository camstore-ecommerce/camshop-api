...
export class CartService implements OnModuleInit {
	...
	constructor(@Inject(USERS_CLIENT) private readonly userClient: ClientGrpc) {}

	onModuleInit() {
		this.cartServiceClient =
			this.userClient.getService<CartServiceClient>(CART_SERVICE_NAME);
	}
